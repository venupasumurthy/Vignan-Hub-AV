...
export default function Circulars() {
  ...
  const createCircular = async (e) => {
    ...
    try {
      ...
      // Create notifications for all users or specific audience
      const allUsers = await base44.entities.User.list();
      const targetUsers = newCircular.target_audience === 'all' 
        ? allUsers 
        : allUsers.filter(u => u.role === (newCircular.target_audience === 'students' ? 'user' : 'admin'));
        ...
        <div className="flex items-center justify-between">
          ...
          {user?.role === 'admin' && (
            <button
              ...
              className="clay-button px-6 py-3 flex items-center gap-2 text-pink-600 font-medium"
            >
          ...
          >
            ...
            >
              ...
              <form onSubmit={createCircular} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="clay-button w-full px-6 py-3 bg-gradient-to-r from-pink-600 to-red-600 text-white font-medium rounded-2xl"
                >
                  Post Circular
                </button>
              </form>
