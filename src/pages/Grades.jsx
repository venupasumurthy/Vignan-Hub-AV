    ...
    return (
      <div className="max-w-7xl mx-auto">
        <div className="clay-card p-8 mb-8">
          ...
          <p className="text-gray-600">Review student submissions, award marks, points and badges</p>
        </div>
            ...
            <div className="grid gap-4">
              {pendingSubmissions.map((submission, index) => (
                ...
                >
                  ...
                  <div className="mb-4 p-4 rounded-2xl bg-gradient-to-r from-gray-50 to-blue-50">
                    <p className="text-sm font-medium text-gray-700 mb-2">Submission Content:</p>
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="clay-button px-6 py-2 bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium rounded-2xl flex items-center gap-2"
                    >
            ...
            >
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="font-bold text-gray-800 mb-3">Submission Content:</h3>
                    <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-50 to-blue-50">
                  ...
                  {selectedSubmission.file_url && (
                    <div>
                      <h3 className="font-bold text-gray-800 mb-3">Attached File:</h3>
                      <a
                        href={selectedSubmission.file_url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="clay-button px-6 py-3 text-blue-600 font-medium flex items-center gap-2 inline-flex"
                      >
                  ...
                  {selectedSubmission.feedback && (
                    <div>
                      <h3 className="font-bold text-gray-800 mb-3">Your Feedback:</h3>
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      className="clay-button flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium rounded-2xl flex items-center justify-center gap-2"
                    >
                      <Trophy className="w-5 h-5" />
              ...
              >
                ...
                <form onSubmit={handleAwardSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="clay-button flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white font-medium rounded-2xl"
                    >
                      Submit Grade & Points
                    </button>
                  </div>
