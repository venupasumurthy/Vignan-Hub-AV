...
export default function CourseDetail() {
  ...
  const handleEditResource = async (e) => {
    ...
    try {
      await base44.entities.CourseResource.update(selectedResource.id, resourceData);
          ...
          <div className="flex flex-wrap gap-3">
            {isTeacher && (
              <>
                ...
                <button
                  ...
                  className="clay-button px-6 py-3 flex items-center gap-2 bg-gradient-to-r from-red-500 to-pink-500 text-white font-medium rounded-2xl"
                >
            ...
            {isEnrolled && user?.account_type === 'student' && !isCompleted && (
              <button
                ...
                className="clay-button px-6 py-3 flex items-center gap-2 bg-gradient-to-r from-green-500 to-blue-500 text-white font-medium rounded-2xl"
              >
                <CheckCircle className="w-5 h-5" />
                Mark as Complete
              </button>
