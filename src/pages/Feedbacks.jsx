      ...
      <div className="clay-card p-2 mb-6">
        <div className="flex gap-2">
          <button
            ...
            className={`clay-button flex-1 px-6 py-3 rounded-xl font-medium transition-all ${
              activeTab === 'remarks' ? 'ring-2 ring-purple-500' : ''
            }`}
            style={{
              background: activeTab === 'remarks' 
                ? 'linear-gradient(135deg, #667eea, #764ba2)' 
                : undefined,
              color: activeTab === 'remarks' ? 'white' : '#6b7280'
            }}
          >
          ...
          <button
            ...
            className={`clay-button flex-1 px-6 py-3 rounded-xl font-medium transition-all ${
              activeTab === 'feedback' ? 'ring-2 ring-pink-500' : ''
            }`}
            style={{
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-4 flex-1">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 ${
                        remark.is_positive ? 'bg-green-200' : 'bg-orange-200'
                      }`}>
                        {remark.is_positive ? (
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                            remark.category === 'progress' ? 'bg-blue-100 text-blue-700' :
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className={`clay-button flex-1 px-4 py-3 flex items-center justify-center gap-2 ${
                        remarkData.is_positive ? 'ring-2 ring-green-500' : ''
                      }`}
                      style={{
                    ...
                    <button
                      ...
                      className={`clay-button flex-1 px-4 py-3 flex items-center justify-center gap-2 ${
                        !remarkData.is_positive ? 'ring-2 ring-orange-500' : ''
                      }`}
                      style={{
                        background: !remarkData.is_positive 
