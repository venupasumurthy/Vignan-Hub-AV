...
export default function Quizzes() {
  ...
  const loadData = async () => {
    try {
      ...
      const allAttempts = await base44.entities.QuizAttempt.list('-created_date');
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {user?.account_type === 'student' && quizzes.length === 0 && (
        <div className="clay-card p-6 mb-6 bg-gradient-to-r from-blue-50 to-purple-50">
          <div className="flex items-start gap-3">
            <Info className="w-6 h-6 text-blue-600 flex-shrink-0 mt-1" />
            <div>
              <h3 className="font-bold text-gray-800 mb-2">No Quizzes Available Yet</h3>
              ...
              {user?.account_type === 'teacher' ? (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="clay-button w-full px-4 py-2 font-medium flex items-center justify-center gap-2"
                    style={{ color: '#3b82f6' }}
                  >
                ...
                <div className="space-y-2">
                  {hasAttempted(quiz.id) ? (
                    <>
                      <div className="px-4 py-2 rounded-xl bg-green-100 text-green-700 font-medium text-center">
                    ...
                    <button
                      ...
                      className="clay-button w-full px-4 py-3 font-medium flex items-center justify-center gap-2"
                      style={{
                        background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)',
                        color: 'white'
                      }}
                ...
                <div className="space-y-3">
                  {selectedQuiz.questions[currentQuestionIndex].options.map((option, i) => (
                    <button
                      ...
                      className={`clay-button w-full px-4 py-3 text-left font-medium transition-all ${
                        quizAnswers[currentQuestionIndex] === i
