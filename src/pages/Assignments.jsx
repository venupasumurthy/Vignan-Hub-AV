  ...
  const submitAssignment = async (e) => {
    ...
    try {
      ...
      if (newSubmission.file) {
        const { file_url } = await base44.integrations.Core.UploadFile({ file: newSubmission.file });
        fileUrl = file_url;
      }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`clay-button px-4 py-2 text-sm font-medium ${
                  viewMode === 'enrolled' ? 'bg-purple-100 text-purple-700' : 'text-gray-600'
                }`}
              >
                My Courses Only
              </button>
              <button
                ...
                className={`clay-button px-4 py-2 text-sm font-medium ${
                  viewMode === 'all' ? 'bg-purple-100 text-purple-700' : 'text-gray-600'
                }`}
              >
                All Assignments
              </button>
          ...
          >
            ...
            >
              ...
              <form onSubmit={createAssignment} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="clay-button w-full px-6 py-3 font-medium rounded-2xl"
                  style={{
