    ...
    <div className="max-w-7xl mx-auto">
      ...
      {topPerformers.length >= 3 && (
        <div className="grid grid-cols-3 gap-4 mb-8 max-w-4xl mx-auto">
          ...
          >
            <div className="w-20 h-20 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-2xl" style={{
              background: 'linear-gradient(135deg, #c0c0c0, #a8a8a8)'
            }}>
              {topPerformers[1].name[0].toUpperCase()}
            </div>
            <Medal className="w-10 h-10 mx-auto mb-2 text-gray-400" />
            <h3 className="font-bold text-lg text-gray-800 mb-1">{topPerformers[1].name}</h3>
            <p className="text-2xl font-bold text-purple-600 mb-2">{topPerformers[1].points} pts</p>
          ...
          <motion.div
            ...
            className="clay-card p-6 text-center relative"
          >
            ...
            <h3 className="font-bold text-xl text-gray-800 mb-1">{topPerformers[0].name}</h3>
            <p className="text-3xl font-bold text-pink-600 mb-2">{topPerformers[0].points} pts</p>
          ...
          >
            ...
            <h3 className="font-bold text-lg text-gray-800 mb-1">{topPerformers[2].name}</h3>
            <p className="text-2xl font-bold text-purple-600 mb-2">{topPerformers[2].points} pts</p>
            <div className="flex items-center justify-center gap-4 text-xs text-gray-600">
              <span className="flex items-center gap-1">
                <TrendingUp className="w-3 h-3" />
          ...
          {topPerformers.map((performer, index) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold flex-shrink-0" style={{
                  background: `linear-gradient(135deg, ${getRankColor(index)})`
                }}>
