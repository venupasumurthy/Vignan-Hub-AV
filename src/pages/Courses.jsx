        ...
        {courses.map((course, index) => (
          ...
          >
            ...
            {course.course_materials && course.course_materials.length > 0 && (
              <div className="mb-4 p-2 rounded-lg bg-blue-50">
                  ...
                  {selectedFiles.length > 0 && (
                    <div className="mt-3 space-y-2">
                      ...
                      {selectedFiles.map((file, index) => (
                        <div key={index} className="flex items-center justify-between p-3 rounded-xl bg-white border border-purple-200">
