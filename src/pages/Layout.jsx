...
export default function Layout({ children, currentPageName }) {
  ...
  const navigation = [
    ...
    { name: "Live Classes", path: "CourseResources", icon: Play, roles: ["admin", "user"] },
    { name: "Assignments", path: "Assignments", icon: FileText, roles: ["admin", "user"] },
    { name: "Quizzes", path: "Quizzes", icon: FileQuestion, roles: ["admin", "user"] },
    { name: "Roadmaps", path: "Roadmaps", icon: Map, roles: ["admin", "user"] },
    { name: "Analytics", path: "Analytics", icon: TrendingUp, roles: ["user"] },
    { name: "Grades", path: "Grades", icon: Award, roles: ["admin", "user"] },
    ...
    { name: "Feedbacks", path: "Feedbacks", icon: MessageSquare, roles: ["admin", "user"] },
