    ...
    <div className="max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-4 rounded-2xl bg-gradient-to-r from-green-50 to-blue-50">
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-r from-yellow-50 to-orange-50">
            <h3 className="font-bold text-gray-800 mb-2">📈 Areas to Improve</h3>
            <ul className="text-sm text-gray-700 space-y-1">
          ...
          <div className="p-4 rounded-2xl bg-gradient-to-r from-purple-50 to-pink-50">
